...
public class CatalogoController {
    ...
    @DeleteMapping(UrlConstant.CATALOGO_DELETE_ITEM)
    public ResponseEntity<?> updateEstadoItem(@PathVariable int id){
        boolean newModel = service.deleteItem(id);
        logger.error("Item actualizado: {}", id);
        return new ResponseEntity<>(newModel,HttpStatus.OK);
    }
